...
func NewIO() *IO {
	...
	io.color256Enabled = io.colorEnabled && color256Supported()
	io.colorScheme = NewColorScheme(io.colorEnabled, io.color256Enabled)
...
// Color256Enabled returns true if colored output using 256 color is enabled.
func (io *IO) Color256Enabled() bool {
	return io.color256Enabled
}
...
// Test returns an IO which does not read or write to any real outputs.
func Test() *IO {
	return &IO{
